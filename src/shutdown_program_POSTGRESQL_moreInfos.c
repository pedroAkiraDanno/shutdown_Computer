...
// Include platform-specific headers
    ...
    #include <lmcons.h>  // For GetUserName() on Windows
#elif __linux__
    #include <unistd.h>  // For sleep() and getpwuid() on Linux
    #include <pwd.h>     // For getpwuid() on Linux
    #include <limits.h>  // For HOST_NAME_MAX on Linux
#endif
...
int main() {
    ...
    // Add a delay before shutting down (1 second)
    printf("Waiting for 1 second before shutting down...\n");
#ifdef _WIN32
    Sleep(5000); // 1000 milliseconds = 1 second 
#else
    sleep(5); // 1 second
#endif
...
LINUX:
            ...
            gcc -o shutdown_logger shutdown_logger.c -lpq
            Run the program:
...
WINDOWS:
        ...
        gcc shutdown_program_POSTGRESQL_moreInfos.c -o shutdown_program_POSTGRESQL_moreInfos.exe -I "C:\Program Files\PostgreSQL\17\include" -L "C:\Program Files\PostgreSQL\17\lib" -lpq

        gcc shutdown_program_POSTGRESQL_moreInfos.c -o shutdown_program_POSTGRESQL_moreInfos.exe -I "C:\Program Files\PostgreSQL\16\include" -L "C:\Program Files\PostgreSQL\16\lib" -lpq
